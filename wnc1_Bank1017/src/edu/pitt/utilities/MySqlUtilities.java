...
public class MySqlUtilities implements DbUtilities{
    ...
    private String dbName = "wnc1_bank1017"; // default database name
    private String dbUserName = "wnc1"; // login name for the database server
    private String dbPassword = "1497272"; // password for the database server
